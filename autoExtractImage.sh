...
readonly SAVE="$HOME/Desktop/data/patch/16-48-48-2-0001/cancer" 
readonly LOG="fail/extractImage.txt"
readonly PATCHSIZE="16-48-48"
readonly SLIDE="8-24-24"
...
do
	...
	python3 extractImage.py ${image} ${label} ${save} --mask_path ${mask} --slide $SLIDE --threshold $THRESHOLD
